...
umap_save_location = 'DataExtraction/dataresults/umap.png'
tsne_save_location = 'DataExtraction/dataresults/tsne.png'
...
dendogram_save_location = 'DataExtraction/dataresults/dendogram.png'
...
print("head of the combined dataset:", full_dataset.head())
...
#plot_2dim_data(X_train_lda2, y_train, 'LDA 2D', lda_2d_save_location)
#plot_3dim_data_3d(X_train_lda3, y_train, 'LDA 3D', lda_3d_save_location)
...
agglomerative_clustering_dendrogram(X_combined, y_combined, "Dendrogram for std dataset")
'''
...
# plot silhouette
plot_silhouette(X_combined, clusters_num, silhouette_save_location, 'Silhouette for std dataset')
print("done...\n\n\n\n")

print('plotting tsne...')
plot_tsne(X_combined, y_combined, tsne_save_location)
print("done...\n\n\n\n")
print("Plotting umap...")
plot_umap(X_combined, y_combined, umap_save_location)
print("done...\n\n\n\n")
