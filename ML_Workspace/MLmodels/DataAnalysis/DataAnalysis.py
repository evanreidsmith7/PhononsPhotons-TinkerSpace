...
# plt.savefig('MLmodels/DataAnalysis/Results/Histogram.png')  
# plt.show()
...
# plt.savefig('MLmodels/DataAnalysis/Results/ScatterPlot.png')  
# plt.show()
...
plt.savefig('MLmodels/DataAnalysis/Results/Kmeans.png')  
plt.show()