...
#define AI_NET_OBJ_INSTANCE g_ann_756
 
#undef AI_ANN_756_MODEL_SIGNATURE
#define AI_ANN_756_MODEL_SIGNATURE     "812dba3eee53e69fe6bbeb2c76d647ce"
...
#define AI_TOOLS_DATE_TIME   "Mon Apr  1 23:14:06 2024"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_ANN_756_N_BATCHES
#define AI_ANN_756_N_BATCHES         (1)

static ai_ptr g_ann_756_activations_map[1] = AI_C_ARRAY_INIT;
static ai_ptr g_ann_756_weights_map[1] = AI_C_ARRAY_INIT;
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0, 0x0,
  AI_SHAPE_INIT(4, 756, 756, 1, 1), AI_STRIDE_INIT(4, 1, 378, 285768, 285768),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  2, 0x0,
  AI_SHAPE_INIT(4, 756, 512, 1, 1), AI_STRIDE_INIT(4, 1, 378, 193536, 193536),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 574280, 1, 1),
    574280, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 5072, 1, 1),
    5072, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_ANN_756_IN_NUM, &serving_default_dense_input0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_ANN_756_OUT_NUM, &nl_5_output),
  &gemm_0_layer, 0, NULL)
...
/******************************************************************************/
AI_DECLARE_STATIC
ai_bool ann_756_configure_activations(
...
/******************************************************************************/
AI_DECLARE_STATIC
ai_bool ann_756_configure_weights(
  ai_network* net_ctx, const ai_network_params* params)
{
  AI_ASSERT(net_ctx)
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_ANN_756_MODEL_NAME,
      .model_signature   = AI_ANN_756_MODEL_SIGNATURE,
  ...
  ai_handle* network, const ai_handle activations[], const ai_handle weights[])
{
    ...
    if (ai_ann_756_data_params_get(&params) != true) {
        err = ai_ann_756_get_error(*network);
        return err;
    }
#if defined(AI_ANN_756_DATA_ACTIVATIONS_COUNT)
    if (activations) {
...
#endif
#if defined(AI_ANN_756_DATA_WEIGHTS_COUNT)
    if (weights) {
...
AI_API_ENTRY
ai_i32 ai_ann_756_forward(ai_handle network, const ai_buffer* input)
{
