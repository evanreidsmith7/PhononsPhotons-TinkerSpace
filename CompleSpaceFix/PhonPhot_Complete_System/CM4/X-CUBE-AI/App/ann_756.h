...
/******************************************************************************/
#define AI_ANN_756_MODEL_NAME          "ann_756"
#define AI_ANN_756_ORIGIN_MODEL_NAME   "node_04_01_223958_ann_756_extra_layers"

/******************************************************************************/
#define AI_ANN_756_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_ANN_756_IN_NUM        (1)

AI_DEPRECATED
#define AI_ANN_756_IN \
  ai_ann_756_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_ANN_756_IN_SIZE { \
  AI_ANN_756_IN_1_SIZE, \
}
#define AI_ANN_756_IN_SIZE_BYTES { \
  AI_ANN_756_IN_1_SIZE_BYTES, \
}
#define AI_ANN_756_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_ANN_756_IN_1_CHANNEL     (756)
#define AI_ANN_756_IN_1_SIZE        (756)
#define AI_ANN_756_IN_1_SIZE_BYTES  (3024)

/******************************************************************************/
#define AI_ANN_756_OUT_NUM       (1)

AI_DEPRECATED
#define AI_ANN_756_OUT \
  ai_ann_756_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_ANN_756_OUT_SIZE { \
  AI_ANN_756_OUT_1_SIZE, \
}
#define AI_ANN_756_OUT_SIZE_BYTES { \
  AI_ANN_756_OUT_1_SIZE_BYTES, \
}
#define AI_ANN_756_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_ANN_756_OUT_1_CHANNEL     (12)
#define AI_ANN_756_OUT_1_SIZE        (12)
#define AI_ANN_756_OUT_1_SIZE_BYTES  (48)

/******************************************************************************/
#define AI_ANN_756_N_NODES (10)
 ...
 * using @ref ai_ann_756_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_error ai_ann_756_create_and_init(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_ann_756_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_ann_756_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_ANN_756_*
 * defines into file @ref ann_756.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
