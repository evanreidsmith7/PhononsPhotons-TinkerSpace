...
/* USER CODE END Boot_Mode_Sequence_0 */
  ...
  // Disabled the cache initialization as a band-aid fix for a Dcache invalidation
  //   issue with the IPC memory
  // The core has no issues without cache considering what little it's doing
  // TODO - Find the macros to invalidate the cache on each read of IPC
  /* Enable I-Cache---------------------------------------------------------*/
  //SCB_EnableICache();
