...
train_confusion_matrix_save_location = 'MLmodels/SVM/Resultssmall/train_confusion_matrix.png'
test_confusion_matrix_save_location = 'MLmodels/SVM/Resultssmall/test_confusion_matrix.png'
txt_location = 'MLmodels/SVM/Resultssmall/metrics.txt'
loss_acc_plot_location = 'MLmodels/SVM/Resultssmall/acc_loss_plot.png'
roc_curve_save_location = 'MLmodels/SVM/Resultssmall/SVM_ROC.png'
