...
// static because these functions are only used in this file
static void i2s_install_atomic();
static void i2s_setpin_atomic();
static int read(int16_t *samples, int count);
